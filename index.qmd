...
*Last updated: 30 January 2026, Ubuntu 24.04*
...
```bash
sudo apt install vim pigz python3-venv python3-pip htop fd-find ripgrep -y
```
...
Install the GNOME [extension](https://extensions.gnome.org/extension/8594/vicinae/) and create keyboard shortcut.
